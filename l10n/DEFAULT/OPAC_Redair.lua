...
A2ADispatcher:SetDefaultCapTimeInterval( 900, 1100 ) --between 15mins and 20mins  NECK: DAY 900, 1200  NIGHT: 1700,1900
...
for i,_gci_airfield in ipairs(airfield_GCI_table) do
  ...
  A2ADispatcher:SetSquadronGci(_gci_airfield,500,1200) -- NECK: Day 600, 1200  Night 2100, 2700
